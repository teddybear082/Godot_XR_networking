...
func _physics_process(delta):
	...
	$FPController/avatar/AnimationTree.set("parameters/lefthandpose/blend_amount", get_left_controller_grip()) #get_left_handpose_blend()) )
	$FPController/avatar/AnimationTree.set("parameters/righthandpose/blend_amount", get_right_controller_grip()) #get_right_handpose_blend()) 
	$FPController/avatar/AnimationTree.set("parameters/lefthandposetrig/blend_amount",  get_left_controller_trigger())#get_left_trigger_blend()) 
	$FPController/avatar/AnimationTree.set("parameters/righthandposetrig/blend_amount", get_right_controller_trigger()) #get_right_trigger_blend()) #
...
func avatartoframedata():
	...
	var fd = {  NCONSTANTS2.CFI_VRORIGIN_POSITION: arvrorigin.transform.origin, 
				NCONSTANTS2.CFI_VRORIGIN_ROTATION: arvrorigin.transform.basis.get_rotation_quat(), 
...
func framedatatoavatar(fd):
	...
	left_controller.transform = overwritetranform(left_controller.transform, fd.get(NCONSTANTS2.CFI_VRHANDLEFT_ROTATION), fd.get(NCONSTANTS2.CFI_VRHANDLEFT_POSITION))
	right_controller.transform = overwritetranform(right_controller.transform, fd.get(NCONSTANTS2.CFI_VRHANDRIGHT_ROTATION), fd.get(NCONSTANTS2.CFI_VRHANDRIGHT_POSITION))
